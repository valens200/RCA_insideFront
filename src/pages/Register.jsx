        ...
        <div className='border grid   w-[98%] md:w-[25%] mx-auto h-[60vh] text-black'>
            <form onSubmit={(e) => register(e)} className='md:w-[80%] mx-auto' >
                <div className='w-[90%] h-[30%]  mx-auto'>
                    ...
                    <p className='text-center font-sans'>Register and inside your self</p>   
                </div>
                <div className='h-[60%]'>
                ...
                {footerLinks.registerInputs.map((input, index) => (
                   ...
                   <TextField onChange={(e) => dispatch(setUsername({input:input.name, value:e.target.value}))} fullWidth  p={2} className="p-2" label={input.name}  type={input.type} />
               </div>
                ))}
                <div className='w-[100%] text-center bg-black text-white  h-[5vh] border'>
                        <input type="submit" className='text-center focus:outline-0 p-2 w-[100%] h-[100%] bg-black p-2 ' value="register"/>
                 </div>
                </div>
                </div>
            </form>
            <div className='flex justify-between w-[80%] mx-auto'>
                ...
                <Link to="/Login">
                <p className='text-[#291E46] hover:font-bold hover:text-black'>Login</p>
                </Link>
            </div>
        </div>
    </div>
