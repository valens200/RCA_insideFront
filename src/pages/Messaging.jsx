          ...
          <div className="w-[40%] overflow-y-scroll flex flex-col space-y-4 h-[100%] border">
            ...
            {users.map((post, index) => (
              <div
                ...
                className="w-[100%]  border hover:bg-[#EBEDEF] hover:border-0  p-4 h-[100%] mx-auto"
              >
          ...
          <div className="w-[60%] overflow-y-scroll border h-[100%]">
            ...
            <div className="bg-white border w-[30%]   p-4 h-[8vh] fixed bottom-0">
              <div className="w-[90%] text-center h-[90%] flex mx-auto">
                ...
                <div className="w-[80%]">
                  <input
                    className="border text-black p-2 focus:outline-0  w-[80%] h-[90%]"
                    type="text"
                    placeholder="chart with "
                    valens
                  />
                  <button className="w-[20%] text-center text-[#00008B] border translate-y-1 font-bold  hover:bg-[#00008B] hover:text-white px-4 text-[1.5rem]   h-[90%] ">
                    <BsCursorFill />
                  </button>
                </div>
              </div>
