...
function LogoutOptions() {
    ...
    const getClass = () => {
        if(showSidebar){
            return "fixed text-black border md:w-[20%]  bg-white right-0 w-[80%]   mx-auto md:mx-0  z-10  h-[90vh]  top-0 translate-y-[10vh] md:translate-y-[10vh] float-right ";
        }else{
