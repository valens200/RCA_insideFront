...
function HomeNav() {
  ...
  const dispatchMethodes = (e) => {
    console.log("hello");
    e.preventDefault();
    dispatch(managePopus({ type: "post" }));
  };
        ...
        <div className="flex h-[100%] w-[30%]  space-x-4  float-rignt flex items-center flex-row">
          <div className="flex w-[50%]  w-[70%] justify-between  h-[100%] flex-row space-x-4">
            <div className="flex items-center flex-row items-center space-x-6 text-[1.5rem]">
              <BsFileDiff onClick={(e) => dispatchMethodes(e)} />
              <Link to="/home">
                {" "}
                <FaHome />
              </Link>
              <div className="flex space-x-2">
                <span className="bg-[red] w-[40%] h-[25%] translate-x-[90%]   z-100 rounded-full font-bold text-white  text-[0.8rem]">
                  12
                </span>
                <BsFillBellFill className="z-20" />
              </div>
              <div className="flex">
                <span className="bg-[red] w-[43%] h-[25%] translate-x-[90%]   z-100 rounded-full font-bold text-white  text-[0.8rem]">
                  12
                </span>
                <Link to="/chart">
                  {" "}
                  <BsChatDotsFill className="z-20" />
                </Link>
              </div>
            </div>
            <div className="flex items-center float-right h-[100%] space-x-2  pt-2  flex-row">
              <Link to="/Profile">
                <div>
                  <img
                    className="h-[3vh] items-center flex w-[8vw] rounded-full"
              ...
              <div className="flex flex-row space-x-4 itemx-center">
                ...
                {!isDarkMode ? (
                  ...
                  <BsMoon
                    onClick={() => dispatch(setDarkMode({ mode: "white" }))}
                  />
                )}
              </div>
            </div>
